...
const services = [
  ...
  { id: 'vip_protocol', name: 'VIP airport protocol (VIP meet & greet, airport concierge services)', price: 110000 },
  { id: 'pickup_sedan', name: 'Airport pickup and drop off on arrival with a SEDAN', price: 118400 },
  { id: 'pickup_suv', name: 'Airport pickup and drop off on arrival with an SUV', price: 193600 },
  { id: 'flight_tickets', name: 'Flight tickets (Lagos - Benin - Lagos)', price: 0 },
