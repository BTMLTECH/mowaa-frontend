  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-primary/5 p-4 rounded-lg text-sm space-y-2">
        ...
        <p>
          Please upload these documents below and make sure thatyour passport
          should be valid from at least 6 months from 9th November, 2025. A
          member of our team will be in touch if we require any further
          documentation.
        </p>
      </div>
